class Admb < Formula
  ...
  def install
    ...
    if OS.mac?
      system "make", "g++-#{gcc.any_installed_version.major}-contribs"
      system "make", "g++-#{gcc.any_installed_version.major}-shared"
      system "make", "--directory=src", "CC=gcc-#{gcc.any_installed_version.major}", \
      "CXX=g++-#{gcc.any_installed_version.major}", "copy"
      ######## clang++-debug:
      ######## clang++-all DEBUG=yes
      system "make", "g++-#{gcc.any_installed_version.major}-debug"
